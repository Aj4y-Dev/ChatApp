...
if (fs.existsSync(publicDir)) { //Check if the public folder exist
  app.use(express.static(publicDir)); //Makes files inside public accessible from the browser.

  app.get("/{*any}", (req, res, next) => { //For any route that Express doesn't know about (/about, /profile, etc.), send index.html.
